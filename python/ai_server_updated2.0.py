    ...
    def __init__(self):
        ...
        self.patterns = [
            ...
            },
            {
                ...
                "responses": [
                    "Строительство — моя страсть! Могу построить дом, башню, мост или особняк. Попробуй 'строй особняк'! 🏰",
                    "Хочешь что-то построить? Я умею строить дома, башни, мосты и большие особняки! Напиши 'строй башню'! 🗼",
                    "Архитектура в Minecraft бесконечна! Хочешь роскошный особняк? Напиши 'строй особняк'! 🏗️",
                ]
            },
            {
...
def handle_chat():
    ...
    try:
        ...
        if "помощь" in message_lower or "help" in message_lower:
            ...
            elif "особняк" in message_lower or "mansion" in message_lower:
